...
{
    $.ajax({
    url: "ajax/ValidasiGambarUkur.php?IDFP="+IDFormulirPermohonan,
...
{
    $.ajax({
    url: "ajax/ValidasiGambarUkurBP.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
        $('#InformasiFP').empty();
...
{
    $.ajax({
    url: "ajax/ValidasiGambarUkurBPPersyaratan.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
