...
{
    $.ajax({
    url: "ajax/UbahGambarUkur.php?IDFP="+IDFormulirPermohonan,
...
{
    $.ajax({
    url: "ajax/UbahGambarUkurBP.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
        $('#InformasiFP').empty();
...
{
    $.ajax({
    url: "ajax/UbahGambarUkurBPPersyaratan.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
