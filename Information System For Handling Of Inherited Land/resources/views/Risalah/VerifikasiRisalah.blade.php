...
{{csrf_field()}}
    ...
    <div class="col-md-12 scCol" style="background:white;" id="">
        <div class="panel panel-success" id="grid_block_5">
          <div class="panel-heading">
            <h3 class="panel-title">Informasi Status Risalah</h3>
          </div>
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                <label for="focusedinput" class="col-sm-4 control-label">Status Verifikasi Risalah</label>
                <div class="col-sm-3">
                  <select style="color:black; background-color:white;" readonly class="form-control select" name="IDStatusVerifikasi" required id="IDStatusVerifikasi" data-live-search="true">
                      <option value="1">Telah Diverifikasi</option>
                      <option value="2">Tidak Diverifikasi</option>
                  </select>
                </div>
              </div>
            </div>
        ...
        <div class="">
          ...
          <div class="col-md-4">
            <input type="submit" value="Verifikasi Risalah Berkas Permohonan" class="btn btn-success"><br><br>
          </div>
        </div>
    </div>
