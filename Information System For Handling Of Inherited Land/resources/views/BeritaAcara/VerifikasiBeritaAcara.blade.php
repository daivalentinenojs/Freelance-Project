...
$(document).ready(function()
{
    ...
    DivInformasiBeritaAcara(IDFormulirPermohonan);
});
...
{
    $.ajax({
    url: "ajax/VerifikasiBeritaAcaraSimpan.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
...
function DivInformasiBeritaAcara(IDFormulirPermohonan)
{
    $.ajax({
    url: "ajax/VerifikasiBeritaAcaraSimpanFinal.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
        $('#InformasiBeritaAcara').empty();
        $("#InformasiBeritaAcara").html(responseText);
    }
    });
}
</script>
