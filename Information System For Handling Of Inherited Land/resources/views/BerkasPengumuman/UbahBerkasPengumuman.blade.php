...
{{csrf_field()}}
    ...
    <div class="col-md-12 scCol" style="background:white;" id="InformasiPembayaran">
        <div class="panel panel-success" id="grid_block_5">
          ...
          <div class="panel-body" id="DivUbahYuridis">
        ...
        <div class="">
        	...
        	<div class="col-md-4">
        		<input type="submit" value="Ubah Berkas Pengumuman Fisik Dan Yuridis" class="btn btn-success"><br><br>
        	</div>
        </div>
    </div>
</form>
...
$(document).ready(function()
{
    ...
    DivUbahYuridis(IDFormulirPermohonan);
});
...
function DivUbahYuridis(IDFormulirPermohonan)
{
    $.ajax({
    url: "ajax/UbahBerkasYuridis.php?IDFP="+IDFormulirPermohonan,
    context: document.body,
    success: function(responseText) {
        $('#DivUbahYuridis').empty();
        $("#DivUbahYuridis").html(responseText);
    }
    });
}
</script>
