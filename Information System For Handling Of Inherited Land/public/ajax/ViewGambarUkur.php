	...
	<div class="panel-body">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="PetaGrafikal" readonly value="<?php echo $DataFP[0]['Sanggahan']; ?>" class="form-control" required id="PetaGrafikal" style="background:white; color:black;">
				</div>
			</div>
		</div>
		<div class="col-md-6">
