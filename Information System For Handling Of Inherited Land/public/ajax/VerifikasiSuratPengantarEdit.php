...
if(isset($_GET['IDFP'])) {
	...
	$QueryGetDataFP = "SELECT SuratPengantar.Nomor AS 'Nomor', SuratPengantar.NomorSuratPengantar AS 'NomorSuratPengantar',
						...
						SuratPengantar.IDKepalaDesa AS 'IDKepalaDesa', SuratPengantar.IsActive AS 'Status', SuratPengantar.Sanggahan AS 'Sanggahan',
			...
			<div class="panel-body">
				<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="NomorSuratPengantar" readonly value="<?php echo $DataFP[0]['NomorSuratPengantar']; ?>" class="form-control" required id="NomorSuratPengantar" style="background:white; color:black;">
							</div>
						</div>
...
<div class="">
	...
	<div class="col-md-4">
		<input type="submit" value="Ubah Surat Pengantar" class="btn btn-success"><br><br>
	</div>
</div>
<?php } ?>
