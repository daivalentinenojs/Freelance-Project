...
if(isset($_GET['IDFP'])) {
	...
	$QueryGetDataFP = "SELECT FormulirPermohonan.ID AS 'ID', FormulirPermohonan.ID AS 'View', FormulirPermohonan.NamaKuasa AS 'NamaKuasa', Pembayaran.ID AS 'IDPembayaran',
						FormulirPermohonan.AlamatKuasa AS 'AlamatKuasa', FormulirPermohonan.AlamatTanah AS 'AlamatTanah', Persyaratan.ID AS 'IDPersyaratan',
						...
						ON (Persyaratan.ID = FPXP.IDPersyaratan) INNER JOIN Pembayaran ON (FormulirPermohonan.ID = Pembayaran.IDFormulirPermohonan) WHERE FormulirPermohonan.ID = '$IDFP'";
			...
			<div class="panel-body">
				<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="hidden" name="IDPersyaratan" id="IDPersyaratan" value="<?php echo $DataFP[0]['IDPersyaratan']; ?>">
								<input type="hidden" name="IDPembayaran" id="IDPembayaran" value="<?php echo $DataFP[0]['IDPembayaran']; ?>">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="LuasDaerahLetterC" value="<?php echo $DataFP[0]['LuasTanahLetterC']; ?>" readonly class="form-control" required id="LuasTanahLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="LuasDaerahLetterC" value="<?php echo $StatusTanah; ?>" readonly class="form-control" required id="LuasDaerahLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
					</div>
			</div>
