			...
			<div class="panel-body">
				<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="NamaPemohon" value="<?php echo $DataFP[0]['NamaPemohon']; ?>" class="form-control" required id="NamaPemohon" style="background:white; color:black;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="NomorBukuHurufC" value="<?php echo $DataFP[0]['NomorBukuHurufC']; ?>" class="form-control" required id="NomorBukuHurufC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="PersilNoLetterC" value="<?php echo $DataFP[0]['PersilNoLetterC']; ?>" class="form-control" required id="PersilNoLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="KelasLetterC" value="<?php echo $DataFP[0]['KelasLetterC']; ?>" class="form-control" required id="KelasLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" name="JenisTanahLetterC" value="<?php echo $DataFP[0]['JenisTanahLetterC']; ?>" class="form-control" required id="JenisTanahLetterC" style="background:white; color:black;">
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="LuasDaerahLetterC" value="<?php echo $DataFP[0]['LuasDaerahLetterC']; ?>" class="form-control" required id="LuasDaerahLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="LuasTanahLetterC" value="<?php echo $DataFP[0]['LuasTanahLetterC']; ?>" class="form-control" required id="LuasTanahLetterC" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control select" name="StatusTanah" required id="StatusTanah" data-live-search="true">
									<?php if ($StatusTanah == 'Hak Milik') { ?>
										<option value="1" selected>Hak Milik</option>
									<?php } else { ?>
										<option value="1">Hak Milik</option>
									<?php } ?>

									<?php if ($StatusTanah == 'Hak Guna Bangunan') { ?>
										<option value="2" selected>Hak Guna Bangunan</option>
									<?php } else { ?>
										<option value="2">Hak Guna Bangunan</option>
									<?php } ?>

									<?php if ($StatusTanah == 'Hak Pakai') { ?>
										<option value="3" selected>Hak Pakai</option>
									<?php } else { ?>
						...
						<div class="form-group">
								...
								<div class="col-md-8">
										<input type="file" name="FilePersyaratan[]" id="FilePersyaratan" multiple class="file" data-preview-file-type="any"/>
								</div>
						</div>
						<!-- <div class="form-group">
							<label for="focusedinput" class="col-sm-4 control-label">Status Tanah</label>
							<div class="col-sm-3">
								<input type="text" name="StatusTanahUbah" readonly value="<?php echo $StatusTanah; ?>" readonly class="form-control" required id="StatusTanah" onkeypress="return isNumberKey(event)" style="background:white; color:black;">
							</div>
						</div> -->
					</div>
			</div>
