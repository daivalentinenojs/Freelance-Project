...
if(isset($_GET['IDFP'])) {
	...
	$QueryGetDataFP = "SELECT FormulirPermohonan.ID AS 'ID', FormulirPermohonan.ID AS 'View', FormulirPermohonan.NamaKuasa AS 'NamaKuasa',
						FormulirPermohonan.AlamatKuasa AS 'AlamatKuasa', FormulirPermohonan.AlamatTanah AS 'AlamatTanah', BerkasPermohonan.NIB AS 'NIB',
	...
	<div class="panel-body">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="NomorPetaPendaftaran" value="<?php echo $DataFP[0]['NomorPetaPendaftaran']; ?>" onkeypress="return isNumberKey(event)" class="form-control" required id="NomorPetaPendaftaran" style="background:white; color:black;">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">NIB</label>
				<div class="col-sm-3">
					<input type="text" name="NIB" readonly value="<?php echo $DataFP[0]['NIB']; ?>" onkeypress="return isNumberKey(event)" class="form-control" required id="NIB" style="background:white; color:black;">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Tanggal Pengukuran</label>
				<div class="col-sm-3">
					<input type="date" name="Tanggal" value="<?php echo $DataFP[0]['Tanggal']; ?>" class="form-control" required id="Tanggal" style="background:white; color:black;">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Sanggahan</label>
				<div class="col-sm-7">
					<input type="text" name="Sanggahan" value="<?php echo $DataFP[0]['Sanggahan']; ?>" class="form-control" id="Sanggahan" style="background:white; color:black;">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="PetaGrafikal" value="<?php echo $DataFP[0]['PetaGrafikal']; ?>" class="form-control" required id="PetaGrafikal" style="background:white; color:black;">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="date" name="TanggalPemetaan" value="<?php echo $DataFP[0]['TanggalPemetaan']; ?>" class="form-control" required id="TanggalPemetaan" style="background:white; color:black;">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="date" name="TanggalUkur" value="<?php echo $DataFP[0]['TanggalUkur']; ?>" class="form-control" required id="TanggalUkur" style="background:white; color:black;">
				</div>
			</div>
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<input type="submit" value="Ubah Gambar Ukur Berkas Permohonan" class="btn btn-success"><br><br>
	</div>
</div>
<?php } ?>
