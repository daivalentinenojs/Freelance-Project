			...
			<div class="panel-body">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="NamaKuasa" class="form-control" id="NamaKuasa" value="<?php echo $DataFP[0]['NamaKuasa']; ?>" style="background:white; color:black;">
						</div>
					</div>
					<div class="form-group">
							<label for="focusedinput" class="col-sm-4 control-label">File Formulir Permohonan</label>
							<div class="col-md-8">
									<input type="file" name="FileFormulirPermohonan" id="FileFormulirPermohonan" class="file" data-preview-file-type="any"/>
							</div>
					</div>
					<!-- <div class="form-group">
							<label for="focusedinput" class="col-sm-4 control-label">File Formulir Permohonan</label>
							<div class="col-md-8">
									<a href="foto/FormulirPermohonan/<?php echo $DataFP[0]['ID']?>.jpg"><img src="foto/FormulirPermohonan/<?php echo $DataFP[0]['ID']?>.jpg" alt="" style="border-radius:10px;"></a>
							</div>
					</div> -->
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" value="<?php echo $DataFP[0]['AlamatKuasa']; ?>" name="AlamatKuasa" class="form-control" id="AlamatKuasa" style="background:white; color:black;">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" value="<?php echo $DataFP[0]['AlamatTanah']; ?>" name="AlamatTanah" class="form-control" required id="AlamatTanah" style="background:white; color:black;">
						</div>
					</div>
				</div>
		</div>
