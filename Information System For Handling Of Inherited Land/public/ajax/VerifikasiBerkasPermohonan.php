	...
	<div class="panel-body">
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="Sanggahan" value="" class="form-control" id="Sanggahan" style="background:white; color:black;">
				</div>
			</div>
		</div>
	</div>
...
<div class="">
	...
	<div class="col-md-4">
		<input type="submit" value="Verifikasi Berkas Pengumuman Fisik Dan Yuridis" class="btn btn-success"><br><br>
	</div>
</div>
<?php } ?>
