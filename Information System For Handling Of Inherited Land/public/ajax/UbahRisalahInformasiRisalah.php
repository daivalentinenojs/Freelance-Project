...
if(isset($_GET['IDFP'])) {
	...
	if ($IDFP > 0) {
		$QueryGetDataFP = "SELECT FormulirPermohonan.ID AS 'ID', FormulirPermohonan.IDPemohon AS 'IDPemohon', Pemohon.Nama AS 'NamaPemohon', Persyaratan.StatusTanah AS 'StatusTanah',
												...
												BuktiPerpajakan.StatusVerponding AS 'StatusVerponding', BuktiPerpajakan.StatusIPEDA AS 'StatusIPEDA', BuktiPerpajakan.LainLain AS 'LainLain',
	...
	<div class="panel-body">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="hidden" name="IDRisalah" value="<?php echo $DataFP[0]['IDRisalah']; ?>" class="form-control" id="IDRisalah">
					<input type="text" name="Sengketa" value="<?php echo $DataFP[0]['SengketaRisalah']; ?>" class="form-control" id="Sengketa">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="CatatanKeberatan" value="<?php echo $DataFP[0]['CatatanKeberatan']; ?>" class="form-control" required id="CatatanKeberatan">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Keterangan Sengketa</label>
				<div class="col-sm-7">
					<input type="text" name="KeteranganSengketa" value="<?php echo $DataFP[0]['KeteranganSengketa']; ?>" class="form-control" required id="KeteranganSengketa">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Beban Atas Tanah</label>
				<div class="col-sm-5">
					<input type="text" name="BebanAtasTanah" value="<?php echo $DataFP[0]['BebanAtasTanah']; ?>" class="form-control" required id="BebanAtasTanah">
				</div>
			</div>
			<div class="form-group">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="BangunanKepentingan" value="<?php echo $DataFP[0]['BangunanKepentingan']; ?>" class="form-control" id="BangunanKepentingan">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="KeteranganBangunanAtasTanah" value="<?php echo $DataFP[0]['KeteranganBangunanAtasTanah']; ?>" class="form-control" id="KeteranganBangunanAtasTanah">
				</div>
			</div>
			<div class="form-group">
	...
	<div class="panel-body">
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="hidden" name="IDBuktiPerpajakan" value="<?php echo $DataFP[0]['IDBuktiPerpajakan']; ?>" class="form-control" required id="IDBuktiPerpajakan">
					<input type="date" name="TanggalBuktiPerpajakan" value="<?php echo $TanggalBuktiPerpajakan; ?>" class="form-control" required id="TanggalBuktiPerpajakan">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Status Verponding</label>
				<div class="col-sm-5">
					<select class="form-control select" name="StatusVerponding" required id="StatusVerponding" data-live-search="true">
						<?php if ($DataFP[0]['StatusVerponding'] == '1') { ?>
							<option value="1" selected>NULL</option>
							<option value="2">Verponding</option>
							<option value="3">Verponding Indonesia</option>
						<?php } elseif ($DataFP[0]['StatusVerponding'] == '2') {?>
							<option value="1">NULL</option>
							<option value="2" selected>Verponding</option>
							<option value="3">Verponding Indonesia</option>
						<?php } elseif ($DataFP[0]['StatusVerponding'] == '3') {?>
							<option value="1">NULL</option>
							<option value="2">Verponding</option>
							<option value="3" selected>Verponding Indonesia</option>
						<?php } ?>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<select class="form-control select" name="StatusIPEDA" required id="StatusIPEDA" data-live-search="true">
						<?php if ($DataFP[0]['StatusIPEDA'] == '1') { ?>
							<option value="1" selected>NULL</option>
							<option value="2">IPEDA</option>
							<option value="3">PBB</option>
							<option value="4">SPPT</option>
						<?php } elseif ($DataFP[0]['StatusIPEDA'] == '2') {?>
							<option value="1">NULL</option>
							<option value="2" selected>IPEDA</option>
							<option value="3">PBB</option>
							<option value="4">SPPT</option>
						<?php } elseif ($DataFP[0]['StatusIPEDA'] == '3') {?>
							<option value="1">NULL</option>
							<option value="2">IPEDA</option>
							<option value="3" selected>PBB</option>
							<option value="4">SPPT</option>
						<?php } elseif ($DataFP[0]['StatusIPEDA'] == '4') {?>
							<option value="1">NULL</option>
							<option value="2">IPEDA</option>
							<option value="3">PBB</option>
							<option value="4" selected>SPPT</option>
						<?php } ?>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="LainLain" value="<?php echo $DataFP[0]['LainLain']; ?>" class="form-control" required id="LainLain">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="UraianPatokD" value="<?php echo $DataFP[0]['UraianPatokD']; ?>" class="form-control" required id="UraianPatokD">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Uraian Verponding</label>
				<div class="col-sm-7">
					<input type="text" name="UraianVerponding" value="<?php echo $DataFP[0]['UraianVerponding']; ?>" class="form-control" required id="UraianVerponding">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Uraian IPEDA</label>
				<div class="col-sm-7">
					<input type="text" name="UraianIPEDA" value="<?php echo $DataFP[0]['UraianIPEDA']; ?>" class="form-control" required id="UraianIPEDA">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Uraian Lain</label>
				<div class="col-sm-7">
					<input type="text" name="UraianLain" value="<?php echo $DataFP[0]['UraianLain']; ?>" class="form-control" required id="UraianLain">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Tahun Bukti Perpajakan</label>
				<div class="col-sm-3">
					<input type="text" name="TahunBuktiPerpajakan" value="<?php echo $DataFP[0]['TahunBuktiPerpajakan']; ?>" class="form-control" required id="TahunBuktiPerpajakan">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="panel-body">
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="hidden" name="IDKenyataan" value="<?php echo $DataFP[0]['IDBuktiPerpajakan']; ?>" class="form-control" required id="IDKenyataan">
					<input type="text" name="KeteranganTahun" value="<?php echo $DataFP[0]['KeteranganTahun']; ?>" class="form-control" required id="KeteranganTahun">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Keterangan Cara</label>
				<div class="col-sm-5">
					<input type="text" name="KeteranganCara" value="<?php echo $DataFP[0]['KeteranganCara']; ?>" class="form-control" required id="KeteranganCara">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="KeteranganAlih" value="<?php echo $DataFP[0]['KeteranganAlih']; ?>" class="form-control" required id="KeteranganAlih">
				</div>
			</div>
			<div class="form-group">
	...
	<div class="panel-body">
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-5">
  				<input type="hidden" name="IDStatusTanah" value="<?php echo $DataFP[0]['IDStatusTanah']; ?>" class="form-control" required id="IDStatusTanah">
	...
	<div class="panel-body">
		<div class="col-md-6" id="DivKesimpulanStatusTanah">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="hidden" name="IDKesimpulanStatusTanah" value="<?php echo $DataFP[0]['IDKesimpulanStatusTanah']; ?>" class="form-control" required id="IDKesimpulanStatusTanah">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="Uraian" value="<?php echo $DataFP[0]['UraianKesimpulanStatusTanah']; ?>" class="form-control" required id="Uraian">
				</div>
			</div>
			<div class="form-group">
	...
	<div class="panel-body">
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="hidden" name="IDSanggahan" value="<?php echo $DataFP[0]['IDSanggahan']; ?>" class="form-control" required id="IDSanggahan">
					<select class="form-control select" name="AlasanPenyanggah" id="AlasanPenyanggah" data-live-search="true">
						<?php if ($DataFP[0]['AlasanPenyanggah'] == 1) { ?>
							<option value="1" selected>Terdapat Sengketa Mengenai Batas</option>
							<option value="2">Terdapat Sanggahan Mengenai Batas</option>
						<?php } else {?>
							<option value="1">Terdapat Sengketa Mengenai Batas</option>
							<option value="2" selected>Terdapat Sanggahan Mengenai Batas</option>
						<?php } ?>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="SengketaDengan" value="<?php echo $DataFP[0]['SengketaDengan']; ?>" class="form-control" id="SengketaDengan">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select class="form-control select" name="AdaSanggahan" id="AdaSanggahan" data-live-search="true">
						<?php if ($DataFP[0]['AdaSanggahan'] == 1) { ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" name="Penyelesaian" value="<?php echo $DataFP[0]['Penyelesaian'] ?>" class="form-control" id="Penyelesaian">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="NamaPenyanggah" value="<?php echo $DataFP[0]['NamaPenyanggah'] ?>" class="form-control" id="NamaPenyanggah">
				</div>
			</div>
			<div class="form-group">
				<label for="focusedinput" class="col-sm-4 control-label">Alamat Penyanggah</label>
				<div class="col-sm-7">
					<input type="text" name="AlamatPenyanggah" value="<?php echo $DataFP[0]['AlamatPenyanggah'] ?>" class="form-control" id="AlamatPenyanggah">
				</div>
			</div>
			<div class="form-group">
...
<div class="">
	...
	<div class="col-md-4">
		<input type="submit" value="Ubah Risalah Berkas Permohonan" class="btn btn-success"><br><br>
	</div>
</div>
