...
! function(e) {
    ...
    f.prototype = {
        ...
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Kesalahan Upload File</span>',
        msgErrorClass: "file-error-message",
        msgLoading: "Sedang memuat file {index} dari {files} &hellip;",
        msgProgress: "Sedang memuat file {index} dari {files} - {name} - {percent}% selesai.",
        msgSelected: "{n} file terpilih",
