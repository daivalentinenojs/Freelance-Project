...
<div class="col-md-12 scCol" style="background:white;">
   <div class="panel panel-success" id="grid_block_5">
      <div class="panel-heading">
         <h3 class="panel-title">Informasi Nota Jual</h3>
         ...
         <div class="panel-body">
             <p>Halaman ini adalah halaman informasi nota jual. Halaman Informasi Nota Jual digunakan untuk <strong>mencari</strong> dan <strong>menambah</strong> data nota jual yang terdaftar pada <strong>UD Harmonis Motor</strong>.</p><br>
             ...
             <div class="panel panel-default">
                 <div class="panel-heading">
                     <h3 class="panel-title">Tabel Informasi Nota Jual</h3>
                 </div>
                 <div class="panel-body">
                     <table class="table" id="DataTableNotaJual">
                         <thead>
                             <tr>
                                 <th style="text-align:center;">No Nota Jual</th>
...
$(document).ready(function() {
   var dataTable = $('#DataTableNotaJual').DataTable( {
      ...
      "columns":[
         ...
         {"data":8,
            "render" : function ( data, type, full, meta ) {
               return '<div style="text-align:center"><a href="#" class="ViewDataNotaJual" data-id="'+data+'"><i class="fa fa-eye"></i></a></div>';
            }
         },
         {"data":9,
            "render" : function ( data, type, full, meta ) {
...
$(function(){
   $(document).on('click','.ViewDataNotaJual',function(e){
       e.preventDefault();
       $("#myModalView").modal('show');
       $.post('modal/NotaJual/NotaJualModalView.blade.php',
...
$(function(){
   $(document).on('click','.EditDataNotaJual',function(e){
       ...
       $.post('modal/NotaJual/NotaJualModalEdit.blade.php',
           {ID:$(this).attr('data-id')},
           function(html){
