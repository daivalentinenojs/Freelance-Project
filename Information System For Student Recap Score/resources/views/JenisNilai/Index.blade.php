...
<div class="panel-body">
    <p>Pada halaman ini Anda dapat menyaring jenis penilaian untuk diubah berdasarkan mata kuliah dan kelas pararel yang Anda pilih.</p>
    <br>
...
{
    $.ajax({
    url: "jsscript/JenisNilaiUbahTampilKeterangan.php?kodeMkBuka="+kodeMk+"&kpMkBuka="+kpMkBuka+"&NPK="+NPKDosen,
    context: document.body,
    success: function(responseText) {
        $('#divKeterangan').empty();
    ...
    "columns":[
        ...
        {"data": 4,
            "render" : function ( data, type, full, meta ) {
              return '<a data-toggle=\'tooltip\' data-placement=\'top\' class=\'btn btn-warning\' title=\'Klik untuk Mengubah Bobot Nilai\' href=UbahBobotNilai/'+data+'/edit>Ubah</a>';
            }
        }
      ],
      "order":[[0, 'asc']]
