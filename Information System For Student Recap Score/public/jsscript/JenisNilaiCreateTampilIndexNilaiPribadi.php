<?php
if(isset($_GET['kodeMkBuka']) AND isset($_GET['kpMkBuka']) AND isset($_GET['ketentuanNilai']) AND isset($_GET['NPK'])) // Checked V Y
{
	...
	FROM Nilai INNER JOIN BAAK.Karyawan ON Nilai.DosenPembuat = BAAK.Karyawan.NPK WHERE Nilai.KodeMkBuka = '$Kode' AND Nilai.KP = '$KPSekarang' AND Nilai.Syarat = 1";
