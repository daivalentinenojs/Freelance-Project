<?php
if(isset($_GET['kodeMkBuka']) AND isset($_GET['kpMkBuka']) AND isset($_GET['NPK']) AND isset($_GET['kodeNilai'])) // Checked V
{
		...
		if ($CheckJenisNilai[0]['Jenis'] == 'UTS' || $CheckJenisNilai[0]['Jenis'] == 'UAS')
		{
				...
				if ($CheckJenisNilai[0]['Jenis'] == 'UTS')
				{
						...
						if (empty($BeritaAcaraUTS[0]['CheckBeritaAcaraUTS']))
						{
								...
								echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='right' title='Keterangan'>BAAK belum melakukan cetak presensi UTS</label>";
						}
						else
						{
								echo "<label class='col-md-3 control-label'>Keterangan</label>";
								echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='right' title='Keterangan'>Silahkan Klik Tombol Ubah Nilai</label>";
						}
				}
				else if ($CheckJenisNilai[0]['Jenis'] == 'UAS')
				{
						...
						if (empty($BeritaAcaraUAS[0]['CheckBeritaAcaraUAS']))
						{
								...
								echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='right' title='Keterangan'>BAAK belum melakukan cetak presensi UAS</label>";
						}
						else
						{
								echo "<label class='col-md-3 control-label'>Keterangan</label>";
	...
	else
	{
				...
				{
					echo "<label class='col-md-3 control-label'>Keterangan</label>";
					echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='top' title='Keterangan'>Nilai Mahasiswa Telah Dikalkulasi</label>";
				}
				else if ($JumlahSiapUpload['JumlahSiapUpload'] >= 1)
				{
					echo "<label class='col-md-3 control-label'>Keterangan</label>";
					echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='top' title='Keterangan'>Nilai Mahasiswa Telah Diverifikasi</label>";
				}
				else if ($JumlahTelahDiUpload['JumlahTelahDiUpload'] >= 1)
				{
					echo "<label class='col-md-3 control-label'>Keterangan</label>";
					echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='top' title='Keterangan'>Nilai Mahasiswa Telah Diunggah</label>";
				}
				else
				{
					echo "<label class='col-md-3 control-label'>Keterangan</label>";
					echo "<label class='col-md-6 control-label' style='text-align:left;' data-toggle='tooltip' data-placement='top' title='Tidak Ada Nilai Mahasiswa yang telah diinputkan'>Belum ada Nilai Mahasiswa yang diinputkan !</label>";
				}
	}
