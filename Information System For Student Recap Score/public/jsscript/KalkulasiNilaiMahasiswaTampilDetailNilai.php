<?php
if(isset($_GET['KodeSubString']) AND isset($_GET['KodeMkBuka']) AND isset($_GET['KPMkBuka']) AND isset($_GET['KodeKalkulasi']))
{
	...
	if ($KodeKalkulasi == 1)
	{
			...
			WHERE BAAK.MhsAmbilMk.KodeMkBuka = '$KodeMkBuka' AND BAAK.MhsAmbilMk.KP = '$KPMkBuka' AND BAAK.MhsAmbilMk.HadirUTS = 'N'";
	...
	else if ($KodeKalkulasi == 2)
	{
			$QueryCheckNRPUTSUASNol = "SELECT BAAK.MhsAmbilMk.NRP AS 'NRPUASNol', BAAK.Mahasiswa.Nama AS 'NamaNol'
			FROM BAAK.MhsAmbilMk INNER JOIN BAAK.Mahasiswa ON BAAK.MhsAmbilMk.NRP = BAAK.Mahasiswa.NRP
			WHERE BAAK.MhsAmbilMk.KodeMkBuka = '$KodeMkBuka' AND BAAK.MhsAmbilMk.KP = '$KPMkBuka' AND
