...
if(isset($_GET["kodeMkBuka"]) AND isset($_GET["NPK"]) AND isset($_GET["kpMkBuka"])) // Checked V
{
	...
	if ($CheckBatasNTS[0]['BatasInputNTS'] == 1)
  {
 			...
 			else
 			{
 					...
 					{
 								if ($JumlahSiapUploadUTS['JumlahSiapUploadUTS'] >= 1 || $JumlahTelahDiUploadUTS['JumlahTelahDiUploadUTS'] >= 1)
 								{
 									 echo "1";
 								}
 								else
 					...
 					{
 								if ($JumlahSiapUploadUAS['JumlahSiapUploadUAS'] >= 1 || $JumlahTelahDiUploadUAS['JumlahTelahDiUploadUAS'] >= 1)
 								{
 										echo "3";
 								}
 								else
  ...
  else
  {
	...
	// if (!($JumlahTelahDiUploadUTS['JumlahTelahDiUploadUTS'] >= 1 ||	$JumlahTelahDiUploadUAS['JumlahTelahDiUploadUAS'] >= 1 || $JumlahSiapUploadUTS['JumlahSiapUploadUTS'] >= 1 ||	$JumlahSiapUploadUAS['JumlahSiapUploadUAS'] >= 1))
	// {
	// 		if ($CheckBatasNTS[0]['BatasInputNTS'] == 1)
	// 		{
	// 				if ($JumlahBobotUTS[0]['JumlahBobotUTS'] != 100 && $JumlahBobotUAS[0]['JumlahBobotUAS'] != 100)
