<?php
  ...
  {
      $QueryBlmAturDosenAjarMk = "SELECT BAAK.SemesterAktif.ThnAkademik AS 'DosenThn', BAAK.SemesterAktif.Semester AS 'DosenSemester'
      FROM BAAK.SemesterAktif WHERE now() between BAAK.SemesterAktif.TglAwalKuliah AND BAAK.SemesterAktif.BatasInputNAS;";
      ...
      {
          $QueryBlmAturMhsAmbilMk = "SELECT BAAK.SemesterAktif.ThnAkademik AS 'DosenThn', BAAK.SemesterAktif.Semester AS 'DosenSemester'
          FROM BAAK.SemesterAktif WHERE now() between BAAK.SemesterAktif.TglAwalKuliah AND BAAK.SemesterAktif.BatasInputNAS;";
