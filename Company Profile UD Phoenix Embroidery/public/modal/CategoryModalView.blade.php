...
<div class="modal-body">
       <div class="panel-body">
             <div class="col-md-12">
                 ...
                 <div class="form-group">
                       <label class="col-md-5 control-label">Category Name (English)</label>
                       <div class="col-md-5">
                            <input type="text" class="form-control" value="<?php echo $DataCategory[0]['Name']; ?>" readonly style="background:white; color:black;"/>
                       </div>
                 </div>
                 <div class="form-group">
                       <label class="col-md-5 control-label">Category Name (Indonesian)</label>
                       <div class="col-md-5">
                            <input type="text" class="form-control" value="<?php echo $DataCategory[0]['NamaIndonesia']; ?>" readonly style="background:white; color:black;"/>
                       </div>
                 </div>
                 <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6">
                         <p readonly name="Description" rows="8" cols="60">
                                <?php echo $DataCategory[0]['DeskripsiIndonesia']; ?>
                         </p>
                  </div>
           </div>
             </div>
