...
?>
<h1>Nota Jual PT "X"</h1>
<table>
  <tr>
    <td>Nomor Nota</td>
    <td><?php echo $DataPenjualan[0]['Nomor']; ?></td>
  </tr>
  <tr>
    <td>Tanggal Pesan</td>
  ...
  <tr>
    <td>Tanggal Kirim</td>
    <td><?php echo $tanggalKirimBaru; ?></td>
  </tr>
  <tr>
    <td>Pelanggan</td>
    <td><?php echo $DataPenjualan[0]['NamaToko']; ?></td>
  </tr>
  <tr>
    <td>Karyawan</td>
    <td><?php echo $DataPenjualan[0]['Karyawan']; ?></td>
  </tr>
  <tr>
    <td>Status Barang</td>
...
<div class="form-group">
                   ...
                   <thead ><tr>
                    ...
                    //print_r($Databaris);
                      ...
                      echo "<td style='border-style: solid;'> Rp ".formatMoney($DataPenjualan[0]['Total'])."</td></tr>";
                     ?>
                 </div>
