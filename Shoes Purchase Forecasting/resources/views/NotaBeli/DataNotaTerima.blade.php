   ...
   <div class="panel panel-success" id="grid_block_5">
      ...
      <div class="panel-body">
          ...
          <div class="col-md-2 pull-right">
             <a class="btn btn-success" href="DataNotaTerimaDetail"><i class="fa fa-plus"></i> Tambah Data Nota Terima</a>
          <br><br></div>

          <div class="col-md-2 pull-right">
             <button id="CetakLaporanNotaTerima"  class="btn btn-success"><i class="fa fa-print"></i> Cetak Laporan</button>
          <br><br></div>
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                  <h3 class="panel-title">Tabel Data Nota Terima</h3>
              </div>
              <div class="panel-body">
                  <table class="table" id="DataTablePenerimaan">
                      <thead>
                          <tr>
              ...
              <div class="panel-body">
                  <div class="col-md-4">
                     <div class="form-group">
                           <span class="fa fa-eye"></span>&nbsp;&nbsp;&nbsp;<b>Untuk melihat detail data Nota Terima.</b>
                     </div>
                     <div class="form-group">
                           <span class="fa fa-pencil"></span>&nbsp;&nbsp;&nbsp;<b>Untuk mengubah data Nota Terima.</b>
                     </div>
                     <div class="form-group">
                           <span class="fa fa-trash-o"></span>&nbsp;&nbsp;&nbsp;<b>Untuk menghapus data Nota Terima.</b>
                     </div>
                  </div>
   ...
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Detail Nota Terima</h4>
           </div>
...
$(document).ready(function() {
   var dataTable = $('#DataTablePenerimaan').DataTable({
      "processing": true,
      "serverSide": true,
      "bDestroy": true,
      "scrollX": true,
      "ajax":{
         url : "ajax/PenerimaanIndex.php",
         type: "get",
      },
      "columns":[
         {"data":0},
         ...
         {"data":6,
            "render" : function ( data, type, full, meta ) {
               return '<div style="text-align:center"><a href="#" class="ViewDataPenerimaan" data-id="'+data+'"><i class="fa fa-eye"></i></a></div>';
            }
         }/*,
         {"data":7,
            "render" : function ( data, type, full, meta ) {
...
$(function(){
   $(document).on('click','.ViewDataPenerimaan',function(e){
       e.preventDefault();
       $("#myModal").modal('show');
       $.post('modal/PenerimaanModalView.blade.php',
...
$(function(){
   $(document).on('click','#CetakLaporanNotaTerima',function(e){
       e.preventDefault();
       $("#myModal").modal('show');
       $.post('modal/SettingCetakLaporanNotaTerimaModal.blade.php',
           {ID:$(this).attr('data-id')},
           function(html){
               $(".modal-body").html(html);
           }
