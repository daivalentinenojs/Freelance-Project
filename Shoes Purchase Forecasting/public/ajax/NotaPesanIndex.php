<?php
	...
	$sql = "SELECT p.Nomor AS 'Nomor', p.Tanggal AS 'Tanggal', c.NamaToko AS 'Pelanggan', u.Nama AS 'Karyawan',
	p.Total as 'Total', p.Status as 'Status', p.Nomor as 'View' FROM Pemesanan p, Customer c, User u
	Where p.CustomerID = c.id and p.UserID = u.IDUser";
	...
	if( !empty($requestData['search']['value']) ) {
		$sql.=" WHERE ( p.Nomor LIKE '%".$requestData['search']['value']."%' ";
