       ...
       <div class="panel-body">
             ...
             <div class="col-md-12 scCol" style="background:white;">
                 <div class="panel panel-warning" id="grid_block_12">
                  <div class="panel-heading">
                      <h3 class="panel-title">Bank Information
                            <?php
                            if ($DataNotaJual[0]['IDStatusNotaJual'] == 2) {
                                   echo '(Required)';
                            } else {
                                   echo '(Confirmation)';
                            }
                  ...
                  <div class="panel-body">
                          ...
                          <div class="form-group">
                               ...
                               <div class="col-md-4">
                                    <?php
                                    if ($DataNotaJual[0]['IDStatusNotaJual'] == 2) {
                                           echo '<input type="text" name="NomorRekening" class="form-control" value="'.$DataNotaJual[0]['NomorRekening'].'"  style="background:white; color:black;"/>';
                                    } else {
                                           echo '<input type="text" readonly name="NomorRekening" class="form-control" value="'.$DataNotaJual[0]['NomorRekening'].'"  style="background:white; color:black;"/>';
                                     }
                                    ?>
                                    </div>
                               <label class="col-md-2 control-label">Name</label>
                               <div class="col-md-4">
                                      <?php
                                     if ($DataNotaJual[0]['IDStatusNotaJual'] == 2) {
                                            echo ' <input type="text" name="NamaPemilikRekening" class="form-control" value="'.$DataNotaJual[0]['NamaPemilikRekening'].'"  style="background:white; color:black;"/>';
                                     } else {
                                            echo ' <input type="text" readonly name="NamaPemilikRekening" class="form-control" value="'.$DataNotaJual[0]['NamaPemilikRekening'].'"  style="background:white; color:black;"/>';
                                     }
                                     ?>
                                   </div>
                         </div>
                         <div class="form-group">
                              ...
                              <div class="col-md-10">
                                     <?php
                                     if ($DataNotaJual[0]['IDStatusNotaJual'] == 2) {
                                            echo '<select name="IDBank" required class="form-control select" data-live-search="true">';
                                            foreach ($DataBank as $Bank) {
                                                   if ($Bank['ID'] == $DataNotaJual[0]['IDBank']) {
                                                         echo '<option selected value="'.$Bank['ID'].'">'.' ('.$Bank['NomorRekening'].') '.$Bank['BankName'].' an '.$Bank['NamaPemilikRekening'].'</option>';
                                                   } else {
                                                         echo '<option value="'.$Bank['ID'].'">'.' ('.$Bank['NomorRekening'].') '.$Bank['BankName'].' an '.$Bank['NamaPemilikRekening'].'</option>';
                                                   }
                                            }
                                            echo '</select>';
                                     } else {
                                            echo ' <input type="text" readonly name="NamaPemilikRekening" class="form-control" value="('.$DataNotaJual[0]['BankNomorRekening'].') '.$DataNotaJual[0]['NamaBank'].' an '.$DataNotaJual[0]['BankNamaPemilikRekening'].'"  style="background:white; color:black;"/>';
                                     }
                                     ?>
                              </div>
                       </div>
                       <?php
                            if ($DataNotaJual[0]['IDStatusNotaJual'] == 4) {
           ...
           if ($DataNotaJual[0]['IDStatusNotaJual'] == 2) {
                  ...
                  echo '<input type="button" name="BtnEditNotaJual" value="'.$DataNotaJual[0]['StatusNotaJual'].'" class="btn btn-default">';
           }
           ?>
           </div>
      </div>
