@extends('Master')
@section('Judul','Master Data | Category')
@section('Navigasi')
...
<div class="col-md-12 scCol" style="background:white;">
    <div class="panel panel-success" id="grid_block_5">
      ...
      <div class="panel-body">
         ...
         @endif
          <p>This page is a category information page. The Category Information page is used to <strong> find</strong>, <strong> add</strong>, and <strong> change</strong> category data listed in <strong> {{$Content[0]['Nama']}}</strong>.</p><br>
          <div class="panel-body col-md-12">
             <div class="form-group">
                <button id="CreateDataKategori" class="btn btn-success pull-right" data-toggle><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Category Data</button>
             </div>
          </div>
      ...
      <div class="panel-body">
          ...
          <input type="hidden" name="_token" value="{!! csrf_token() !!}">
              <div class="panel-body">
                  <div class="col-md-4">
                     <div class="form-group">
                           <span class="fa fa-eye"></span>&nbsp;&nbsp;&nbsp;<b>To find the detail of category data.</b>
                     </div>
                     <div class="form-group">
                           <span class="fa fa-pencil"></span>&nbsp;&nbsp;&nbsp;<b>To change the detail of category data.</b>
                     </div>
                  </div>
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="form-group">
                           <b>3. [Search] Feature on the top right of your table used for looking category data fastly.</b>
                     </div>
                  </div>
               </div>
           </form>
                     ...
                     <div class="panel-body">
                           <div class="col-md-12">
                               <div class="form-group">
                                     ...
                                     <div class="col-md-5">
                                          <input type="text" name="NamaKategori" required class="form-control" value="" placeholder="Category Name" style="background:white; color:black;"/>
                                     </div>
                               </div>
                               <div class="form-group">
                               ...
                               <div class="form-group" style="text-align:center;">
                                      <input type="submit" id="BtnCreateKategori" name="BtnCreateKategori" value="Add" class="btn btn-success">
                               </div>
                           </div>
                      </div>
                </div>
...
$(function(){
   $(document).on('click','.ViewDataKategori',function(e){
       ...
       $.post('modal/Category/CategoryModalView.blade.php',
...
$(function(){
   $(document).on('click','.EditDataKategori',function(e){
       ...
       $.post('modal/Category/CategoryModalEdit.blade.php',
           {ID:$(this).attr('data-id')},
           function(html){
