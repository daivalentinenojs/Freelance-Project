@extends('Master')
@section('Judul','Master Data | Employee')
@section('Navigasi')
...
<div class="col-md-12 scCol" style="background:white;">
    <div class="panel panel-success" id="grid_block_5">
      ...
      <div class="panel-body">
         ...
         @endif
          <p>This page is a employee information page. The Employee Information page is used to <strong> find</strong>, <strong> add</strong>, and <strong> change</strong> Employee data listed in <strong> {{$Content[0]['Nama']}}</strong>.</p><br>
          <div class="panel-body col-md-12">
             <div class="form-group">
                <button id="CreateDataKaryawan" class="btn btn-success pull-right" data-toggle><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Employee Data</button>
             </div>
          </div>
      ...
      <div class="panel-body">
          ...
          <input type="hidden" name="_token" value="{!! csrf_token() !!}">
              <div class="panel-body">
                  <div class="col-md-4">
                     <div class="form-group">
                           <span class="fa fa-eye"></span>&nbsp;&nbsp;&nbsp;<b>To find the detail of Employee data.</b>
                     </div>
                     <div class="form-group">
                           <span class="fa fa-pencil"></span>&nbsp;&nbsp;&nbsp;<b>To change the detail of Employee data.</b>
                     </div>
                  </div>
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="form-group">
                           <b>3. [Search] Feature on the top right of your table used for looking Employee data fastly.</b>
                     </div>
                  </div>
               </div>
           </form>
                     ...
                     <div class="panel-body">
                           <div class="col-md-12">
                               <div class="form-group">
                                     ...
                                     <div class="col-md-5">
                                          <input type="text" name="Nama" required class="form-control" value="" placeholder="Employee Name" style="background:white; color:black;"/>
                                     </div>
                               </div>
                               <div class="form-group">
                               ...
                               <div class="form-group">
                                    <label class="col-md-4 control-label">Employee Photo</label>
                                    <div class="col-md-5">
                                          <input type="file" class="fileinput" id="FotoKaryawan" name="FotoKaryawan"/>
                                    </div>
                               </div>
                               <div class="form-group" style="text-align:center;">
                                      <input type="submit" id="BtnCreateKaryawan" name="BtnCreateKaryawan" value="Add" class="btn btn-success">
                               </div>
                           </div>
                      </div>
                </div>
...
<div class="modal fade" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Tutup</span></button>
               <h4 class="modal-title" id="myModalLabel">Change Employee</h4>
           </div>
...
$(function(){
   $(document).on('click','.ViewDataKaryawan',function(e){
       ...
       $.post('modal/Employee/EmployeeModalView.blade.php',
...
$(function(){
   $(document).on('click','.EditDataKaryawan',function(e){
       ...
       $.post('modal/Employee/EmployeeModalEdit.blade.php',
           {ID:$(this).attr('data-id')},
           function(html){
